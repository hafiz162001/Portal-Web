            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    @include('partial.cardHeader', [
                        ...
                        'route' => 'channel-article',
                    ])

                    <div class="card-body">
                        <form action="{{ route('channel-article.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

                                <div class="col-md-12 px-3">
                                    <x-input :isStack="1" id="name" type="text" :defaultValue="old('name')" :isRequired="true"
                                        globalAttribute="name" label="name*"></x-input>
                                </div>
                                <div class="col-md-12 px-3">
                                    <x-input :isStack="1" id="slug" :isDisabled="true" type="text" :defaultValue="old('slug')" :isRequired="true"
                                ...
                                <div class="col-md-12 px-3">
                                    <x-select :isStack="1" globalAttribute="parent_id" label="Parent"
                                        ...
                                        @foreach ( $channelArticle as $data )
