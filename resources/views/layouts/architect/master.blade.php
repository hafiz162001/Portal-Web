...
<body>
                                            ...
                                            <div class="no-gutters row">
                                                ...
                                                <div class="col-sm-6 col-xl-4">
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0);"
                                                                class="nav-link">Resource Groups
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-secondary">
                                        <div class="menu-header-image opacity-5"
                                            style="background-image: url('{{ asset('architect/images/dropdown-header/abstract2.jpg') }}');">
                                        </div>
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-success">
                                        <div class="menu-header-image opacity-1"
                                            style="background-image: url('{{ asset('architect/images/dropdown-header/abstract3.jpg') }}');">
                                        </div>
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-plum-plate">
                                        <div class="menu-header-image"
                                            style="background-image: url('{{ asset('architect/images/dropdown-header/abstract4.jpg') }}');">
                                        </div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/1.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/2.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/3.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/4.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/5.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/9.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/7.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                                                                    class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                            src="{{ asset('architect/images/avatars/8.jpg') }}"
                                                                                            alt=""></div>
                                                                                </div>
                                                                                <div
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                        <div class="menu-header-image opacity-05"
                                            style="background-image: url('{{ asset('architect/images/dropdown-header/city2.jpg') }}');">
                                        </div>
                                    ...
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <img width="42" class="rounded-circle"
                                                src="{{ asset('architect/images/avatars/1.jpg') }}" alt="">
                            ...
                            <ul class="list-group">
                                ...
                                <div class="swatch-holder swatch-holder-img active">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/city1.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/city2.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/city3.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/city4.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/city5.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/abstract1.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/abstract2.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/abstract3.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/abstract4.jpg') }}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{ asset('architect/images/sidebar/abstract5.jpg') }}">
                                    </a>
                                </div>
                            </li>-->
                            </ul>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="mm-show">
                                    ...
                                    <li>
                                        <a href="layouts.html" class="mm-active">
                                            <i class="metismenu-icon">
                                            </i>Layouts
                                        </a>
                                    </li>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Form Layouts
                                    <div class="page-title-subheading">Build whatever layout you need with our
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="">
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="exampleEmail11"
                                                        ...
                                                        id="exampleEmail11" placeholder="with a placeholder"
                                                        type="email" class="form-control"></div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label
                                                        for="examplePassword11"
                                                        class="">Password</label><input name="password"
                                                        id="examplePassword11" placeholder="password placeholder"
                                        ...
                                        <div class="position-relative form-group"><label for="exampleAddress2"
                                                class="">Address 2</label><input name="address2"
                                                id="exampleAddress2" placeholder="Apartment, studio, or floor"
                                    ...
                                    <div>
                                        <form class="form-inline">
                                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group"><label
                                                    for="exampleEmail22" class="mr-sm-2">Email</label><input
                                                    name="email" id="exampleEmail22" placeholder="something@idk.cool"
                                                    type="email" class="form-control"></div>
                                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group"><label
                                                    for="examplePassword22"
                                                    class="mr-sm-2">Password</label><input name="password"
                                                    id="examplePassword22" placeholder="don't tell!" type="password"
                                                    class="form-control"></div>
                                            <button class="btn btn-primary">Submit</button>
                                        </form>
                                        <div class="divider"></div>
                                        <form class="">
                                            <div class="position-relative form-check form-check-inline"><label
                                                    class="form-check-label"><input type="checkbox"
                                                        class="form-check-input"> Some input</label></div>
                                            <div class="position-relative form-check form-check-inline"><label
                                                    class="form-check-label"><input type="checkbox"
                                                        class="form-check-input"> Some other input</label></div>
                                        </form>
                                        <div class="divider"></div>
                                        <form class="form-inline">
                                            <div class="position-relative form-group"><label for="exampleEmail33"
                                                    class="sr-only">Email</label><input name="email"
                                                    id="exampleEmail33" placeholder="Email" type="email"
                                            ...
                                            <div class="position-relative form-group"><label for="examplePassword44"
                                                    ...
                                                    id="examplePassword44" placeholder="Password" type="password"
                                                    class="mr-2 form-control"></div>
                                            <button class="btn btn-primary">Submit</button>
                                        </form>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="">
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleSelectMulti"
                                                class="col-sm-2 col-form-label">Select Multiple</label>
                                            <div class="col-sm-10"><select multiple="" name="selectMulti"
                                                    id="exampleSelectMulti" class="form-control"></select></div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="exampleText"
                                                class="col-sm-2 col-form-label">Text Area</label>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleFile"
                                            ...
                                            <div class="col-sm-10"><input name="file" id="exampleFile" type="file"
                                                ...
                                                <small class="form-text text-muted">This is some placeholder
                                            ...
                                            <div class="col-sm-10">
                                                <div class="position-relative form-check"><label
                                                        class="form-check-label"><input name="radio2" type="radio"
                                                            class="form-check-input"> Option one is this and that—be
                                                        sure to include why it's great</label></div>
                                                <div class="position-relative form-check"><label
                                                        class="form-check-label"><input name="radio2" type="radio"
                                                            class="form-check-input"> Option two can be something else
                                                ...
                                                <div class="position-relative form-check disabled"><label
                                                        class="form-check-label"><input name="radio2" disabled=""
                                                            type="radio" class="form-check-input"> Option three is
                                                        disabled</label></div>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="position-relative form-check"><label
                                                        class="form-check-label"><input id="checkbox2" type="checkbox"
                                                            class="form-check-input"> Check me out</label></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="vertical-timeline-element-content bounce-in">
                                        <h4 class="timeline-title">Something not important
                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                ...
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img
                                                            src="{{ asset('architect/images/avatars/6.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
    ...
    <script src="{{ asset('architect/js/scripts-init/app.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/demo.js') }}"></script>

    <!--CHARTS-->

    <!--Apex Charts-->
    <script src="{{ asset('architect/js/vendors/charts/apex-charts.js') }}"></script>

    <script src="{{ asset('architect/js/scripts-init/charts/apex-charts.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/charts/apex-series.js') }}"></script>

    <!--Sparklines-->
    <script src="{{ asset('architect/js/vendors/charts/charts-sparklines.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/charts/charts-sparklines.js') }}"></script>

    <!--Chart.js-->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.4.0/Chart.min.js"></script>
    <script src="{{ asset('architect/js/scripts-init/charts/chartsjs-utils.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/charts/chartjs.js') }}"></script>

    <!--FORMS-->

    <!--Clipboard-->
    <script src="{{ asset('architect/js/vendors/form-components/clipboard.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/clipboard.js') }}"></script>

    <!--Datepickers-->
    <script src="{{ asset('architect/js/vendors/form-components/datepicker.js') }}"></script>
    <script src="{{ asset('architect/js/vendors/form-components/daterangepicker.js') }}"></script>
    <script src="{{ asset('architect/js/vendors/form-components/moment.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/datepicker.js') }}"></script>

    <!--Multiselect-->
    <script src="{{ asset('architect/js/vendors/form-components/bootstrap-multiselect.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/input-select.js') }}"></script>

    <!--Form Validation-->
    <script src="{{ asset('architect/js/vendors/form-components/form-validation.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/form-validation.js') }}"></script>

    <!--Form Wizard-->
    <script src="{{ asset('architect/js/vendors/form-components/form-wizard.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/form-wizard.js') }}"></script>

    <!--Input Mask-->
    <script src="{{ asset('architect/js/vendors/form-components/input-mask.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/input-mask.js') }}"></script>

    <!--RangeSlider-->
    <script src="{{ asset('architect/js/vendors/form-components/wnumb.js') }}"></script>
    <script src="{{ asset('architect/js/vendors/form-components/range-slider.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/range-slider.js') }}"></script>

    <!--Textarea Autosize-->
    <script src="{{ asset('architect/js/vendors/form-components/textarea-autosize.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/form-components/textarea-autosize.js') }}"></script>

    <!--Toggle Switch -->
    <script src="{{ asset('architect/js/vendors/form-components/toggle-switch.js') }}"></script>


    <!--COMPONENTS-->

    <!--BlockUI -->
    <script src="{{ asset('architect/js/vendors/blockui.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/blockui.js') }}"></script>

    <!--Calendar -->
    <script src="{{ asset('architect/js/vendors/calendar.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/calendar.js') }}"></script>

    <!--Slick Carousel -->
    <script src="{{ asset('architect/js/vendors/carousel-slider.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/carousel-slider.js') }}"></script>

    <!--Circle Progress -->
    <script src="{{ asset('architect/js/vendors/circle-progress.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/circle-progress.js') }}"></script>

    <!--CountUp -->
    <script src="{{ asset('architect/js/vendors/count-up.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/count-up.js') }}"></script>

    <!--Cropper -->
    <script src="{{ asset('architect/js/vendors/cropper.js') }}"></script>
    <script src="{{ asset('architect/js/vendors/jquery-cropper.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/image-crop.js') }}"></script>

    <!--Maps -->
    <script src="{{ asset('architect/js/vendors/gmaps.js') }}"></script>
    <script src="{{ asset('architect/js/vendors/jvectormap.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/maps-word-map.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/maps.js') }}"></script>

    <!--Guided Tours -->
    <script src="{{ asset('architect/js/vendors/guided-tours.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/guided-tours.js') }}"></script>

    <!--Ladda Loading Buttons -->
    <script src="{{ asset('architect/js/vendors/ladda-loading.js') }}"></script>
    <script src="{{ asset('architect/js/vendors/spin.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/ladda-loading.js') }}"></script>

    <!--Rating -->
    <script src="{{ asset('architect/js/vendors/rating.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/rating.js') }}"></script>

    <!--Perfect Scrollbar -->
    <script src="{{ asset('architect/js/vendors/scrollbar.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/scrollbar.js') }}"></script>

    <!--Toastr-->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js" crossorigin="anonymous"></script>
    <script src="{{ asset('architect/js/scripts-init/toastr.js') }}"></script>
    ...
    <!--Tree View -->
    <script src="{{ asset('architect/js/vendors/treeview.js') }}"></script>
    <script src="{{ asset('architect/js/scripts-init/treeview.js') }}"></script>
    ...
    <!--Bootstrap Tables-->
    <script src="{{ asset('architect/js/vendors/tables.js') }}"></script>

    <!--Tables Init-->
    <script src="{{ asset('architect/js/scripts-init/tables.js') }}"></script>
